...
{#if baseImgUpload}
  ...
  <div
    ...
    class="absolute inset-x-0 bottom-8 mx-auto flex items-center ">
...
{#if PreviewBaseImage}
  <div class="relative flex items-center">
    <div class="aspect-[16/9] w-full flex-col bg-certificateSection">
        ...
        <div class="flex gap-6">
          <button
            ...
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="h-6 w-6 text-heading hover:text-primaryBlue ">
              <path
    ...
    <img
      src={fileBlobUrl}
      alt=""
      class="absolute -right-[40px] w-[400px] rounded-md" />
  </div>
{/if}
