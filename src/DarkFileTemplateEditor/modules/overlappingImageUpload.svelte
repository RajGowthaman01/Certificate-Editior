...
{#if PreviewBaseImage}
  ...
  <div class="absolute bottom-0 mx-auto flex w-full items-center justify-between bg-gradient-to-t from-secondary to-transparent px-16 pb-8 pt-24">
	...
	<!-- <div class="relative flex h-screen flex-col justify-center overflow-hidden bg-black/50 p-20">
  <div class="mx-auto w-[5/6] "> -->
	<div class="relative flex items-center">
		<div class="bg-certificateSection aspect-[16/10] w-full flex-col md:flex">
			<div class="px-16 pt-16 text-4xl capitalize text-blue-400">
				Upload <br />
				Image
			</div>
			<div class=" text-primaryGray mt-6 ml-16 break-words">
				<p class="text-sm">
					Choose your <strong>Base Design Image</strong>
					to upload.
					<br />
		...
		<img src={blobURL} class="absolute  -right-[80px] w-[600px] rounded-md" alt="certificate" />
	</div>
	<!-- </div> -->
	<!-- </div> -->
{/if}
