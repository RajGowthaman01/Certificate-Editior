...
<div class="grid grid-cols-2 gap-5">
  <div class="ml-20 flex flex-col justify-center gap-10">
    ...
    <p class="text-base font-normal text-gray2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere, quae dicta! tenetur.</p>
  </div>
  <form enctype="multipart/form-data" id="imageUpload" class="relative ml-20 h-52 w-3/4 flex-col items-center rounded-md border-2 border-dashed border-gray2 bg-white dark:bg-lightGray">
    <input bind:value={inputValue} on:change={uploadImage} type="file" name="uploadimageSec" class="absolute top-0 left-0 py-22 px-6 opacity-0" accept="image/*" />
