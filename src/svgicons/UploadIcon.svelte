<svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 rounded-full border-2 border-Analytics-secondarytext p-1 text-Analytics-secondarytext" viewBox="0 0 24 24">
  <path
    fill="currentColor"
