...
<div class="pb-5">
  ...
  <div class="pr-10">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-full h-8 rounded-md" style="background-color: {signClr};" viewBox="0 0 640 512">
      <path
        fill="white"
  ...
  <div class="pt-3">
    <button on:click={initOTP} class="btn">Initiate</button>
  </div>
</div>
