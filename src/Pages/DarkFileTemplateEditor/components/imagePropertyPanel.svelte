...
<style lang="postcss" global>
	.labelSpan {
		@apply focus:ring-primary_blue group-focus-within:text-primary_blue absolute rounded-md border-none px-2 py-2 text-sm font-bold text-gray-400 outline-none focus:ring-1;
	}
	.lockPositionBtn {
		@apply hover:ring-primary_blue active:bg-primary_blue flex h-8 w-8 items-center justify-center rounded-md hover:ring-1;
	}
	.inputField {
		@apply bg-primary focus:bg-secondary focus:ring-primary_blue w-full rounded-md px-2 py-2 pl-8 text-sm text-white  focus:outline-none focus:ring-1;
	}
	.inputValue {
		@apply bg-primary focus:bg-secondary focus:ring-primary_blue w-full rounded-md px-4 py-2 pl-16 text-sm font-bold text-white focus:outline-none focus:ring-1;
	}
</style>
