...
<style lang="postcss" global>
	.pagination {
		@apply h-4 w-4 rounded-full bg-gray-300 text-xs hover:bg-primaryBlue hover:text-white focus:bg-primaryBlue focus:outline-none active:scale-125 dark:bg-primary md:flex;
	}
</style>
