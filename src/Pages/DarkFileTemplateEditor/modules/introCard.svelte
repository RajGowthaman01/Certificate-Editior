...
<style lang="postcss" global>
  .pagination {
    @apply h-4 w-4 rounded-full bg-gray-300 text-xs hover:bg-primary_blue hover:text-white focus:bg-primary_blue focus:outline-none active:scale-125 dark:bg-black md:flex;
  }
</style>
