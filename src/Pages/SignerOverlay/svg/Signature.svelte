...
<svg xmlns="http://www.w3.org/2000/svg" class="w-full h-8 rounded-md mr-10 border-2 border-lightGray" style="background-color: {$pdfSigning.signColor.color}; border" viewBox="0 0 640 512">
  <path
    fill="white"
