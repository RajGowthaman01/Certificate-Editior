    ...
    <div class="flex ">
      <div class="w-full flex-col items-center px-4">
        ...
        <div class="relative mt-3 flex h-9 w-full items-center gap-2 rounded-md bg-transparent px-2">
          <div class="rounded-md focus:outline-none focus:ring-2 focus:ring-primary_blue">
          ...
          <button on:click={displayUploadSection} class:justify-end={toggleButton} class="group/item relative ml-auto mr-1 flex h-3 w-12 items-center rounded-full bg-heading text-secondaryGray focus:outline-none">
            <button class="relative h-6 w-6 rounded-full bg-primary_blue text-xs text-white focus:outline-none " />
          </button>
        </div>

        <!-- image upload -->
        {#if dargAndDrop}
          <div class="mt-3" transition:slide={{ duration: 500, easing: linear }}>
        ...
        <!-- image preview -->
        {#if imageUploaded}
          <div class="mt-3 items-center" transition:slide={{ duration: 500, easing: linear }}>
