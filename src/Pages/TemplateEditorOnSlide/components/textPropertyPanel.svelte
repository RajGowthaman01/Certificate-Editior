...
<style lang="postcss" global>
	...
	.labelSpan {
		@apply absolute rounded-md text-sm outline-none focus:ring-1 focus:ring-primaryBlue group-focus-within:text-primaryBlue;
	}
	.inputValue {
		@apply w-full rounded-md bg-primary px-4 pl-16 text-sm text-white focus:bg-secondary focus:outline-none focus:ring-1 focus:ring-primaryBlue;
	}
	.fontSizeSelect {
