<script>
  ...
  let uploadSec = true
  let PasteSec = true
  let activePasteComponent = PasteButton
  let activeUploadComponent = UploadButton
  const expandUpload = () => {
...
<p class="pb-3 text-base font-normal leading-relaxed tracking-wide text-textGray">
